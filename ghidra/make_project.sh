...
#   2. Imports  ../firmware/ctfnode.stripped  (the fully stripped aarch64 target).
#   3. Runs Ghidra's full auto-analysis on it (about one second for this file).
#   4. Saves the analysed project to  ./proj/CTFNodeRE
#
# HOW TO RUN:
#
...
TARGET="$HERE/../firmware/ctfnode.stripped"
...
[*] Open it in the Ghidra GUI:
        ...
        # double-click  ctfnode.stripped  -> the listing appears immediately
